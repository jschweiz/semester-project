...
class ExperimentRunner(tune.Trainable):
    ...
    def _build(self):
        ...
        sampler = self.sampler = get_sampler_from_variant(variant, session=self._session)
    ...
    def _restore(self, checkpoint_dir):
        ...
        sampler = self.sampler = get_sampler_from_variant(self._variant, session=self._session)
        self.sampler.__setstate__(picklable['sampler'].__getstate__())
        Qs = self.Qs = get_Q_function_from_variant(
